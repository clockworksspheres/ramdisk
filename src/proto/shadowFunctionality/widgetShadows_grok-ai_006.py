...
from ui_mainwindow_006 import Ui_MainWindow  # Import the generated UI class
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.setWindowTitle("Bigger Blue Shadows with Heavy Highlight (No CustomLineEdit)")
