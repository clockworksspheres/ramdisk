...
from PySide6.QtWidgets import (
    QApplication, QMainWindow, QTableWidget, QTableWidgetItem, QWidget, QGraphicsDropShadowEffect, QLineEdit
)
from PySide6.QtCore import Qt
from PySide6.QtGui import QColor
from ui_mainwindow_005 import Ui_MainWindow  # Import the generated UI class

class CustomLineEdit(QLineEdit):
    """Custom QLineEdit to prevent Tab key insertion and move focus."""
    def keyPressEvent(self, event):
        if event.key() == Qt.Key_Tab:
            self.focusNextInTabOrder()
            return
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.setWindowTitle("Bigger Blue Shadows with Heavy Highlight")

        # Replace QLineEdit with CustomLineEdit to prevent Tab insertion
        # Note: This is done programmatically; alternatively, promote in Qt Designer
        self.ui.lineEdit = CustomLineEdit(self.ui.centralwidget)
        self.ui.lineEdit.setObjectName("lineEdit")
        self.ui.lineEdit.setPlaceholderText("Line Edit 1")
        self.ui.verticalLayout.replaceWidget(self.ui.lineEdit, self.ui.lineEdit)
        
        self.ui.lineEdit_2 = CustomLineEdit(self.ui.centralwidget)
        self.ui.lineEdit_2.setObjectName("lineEdit_2")
        self.ui.lineEdit_2.setPlaceholderText("Line Edit 2")
        self.ui.verticalLayout.replaceWidget(self.ui.lineEdit_2, self.ui.lineEdit_2)
        ...
        # Apply stylesheets with heavy focus highlight (day mode)
    ...
    def set_day_mode_styles(self):
        """Apply stylesheets for day mode with heavy focus highlight."""
    ...
    def set_night_mode_styles(self):
        """Apply stylesheets for night mode with heavy focus highlight."""
        self.ui.lineEdit.setStyleSheet("""
            QLineEdit {
                background: #2b2b2b;
                color: #ffffff;
            ...
            QLineEdit:focus {
                border: 3px solid #ff6200; /* Heavy orange border */
                background: #3a2f2f; /* Subtle orange-tinted dark background */
            }
        """)
        self.ui.lineEdit_2.setStyleSheet("""
            QLineEdit {
