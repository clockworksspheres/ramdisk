...
def main():
    parser = argparse.ArgumentParser(
        description="Create or update Jenkins node with separate Jenkins and SSH key passwords"
    )
    ...
    parser.add_argument(
        "--password",
        required=True,
        help="Jenkins password or API token (NOT SSH key passphrase)"
    )
    ...
    parser.add_argument(
        "--key-passphrase",
        help="Passphrase for SSH private key (optional, different from Jenkins password)"
    )

    args = parser.parse_args()

    # --------------------------------------------------------
    # CONNECT TO JENKINS (USES JENKINS PASSWORD ONLY)
    # --------------------------------------------------------
