...
class ZoomResizeDemoWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("PySide6 Zoom and Resize Demo")
        self.setGeometry(100, 100, 800, 600)
        self.setMinimumSize(400, 300)  # Ensure window is resizable but not too small
        ...
        self.table.horizontalHeader().setStretchLastSection(True)  # Stretch columns
        ...
        # Track original font size and table dimensions
        ...
        self.base_row_height = self.table.rowHeight(0)  # Store default row height
        self.base_column_width = self.table.columnWidth(0)  # Store default column width
