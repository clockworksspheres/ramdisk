...
class ZoomResizeDemoWindow(QMainWindow):
    def __init__(self):
        ...
        self.setMinimumSize(300, 200)  # Reduced minimum size for flexibility
        self.setMaximumSize(3840, 2160)  # Allow large resizing (e.g., 4K displays)

        # Ensure window is not maximized initially to avoid macOS full-screen issues
        self.showNormal()
    ...
    def resizeEvent(self, event):
        # Debug print to confirm window and widget resizing
