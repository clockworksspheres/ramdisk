...
class ZoomResizeDemoWindow(QMainWindow):
    def __init__(self):
        ...
        self.setMinimumSize(400, 300)  # Prevent window from becoming too small
        ...
        self.table.horizontalHeader().setStretchLastSection(True)  # Stretch columns to fill
        ...
        self.base_row_height = self.table.rowHeight(0)  # Default row height
        self.base_column_width = self.table.columnWidth(0)  # Default column width
