...
class ZoomDemoWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("PySide6 Font and Zoom Demo")
        ...
        self.text_edit.setText("QTextEdit (default font)")
        layout.addWidget(QLabel("QTextEdit:"))
        layout.addWidget(self.text_edit)

        # QWebEngineView
        self.web_view = QWebEngineView()
        self.web_view.setHtml("<p>QWebEngineView (default font)</p>")
        layout.addWidget(QLabel("QWebEngineView:"))
        layout.addWidget(self.web_view)

        # QLabel
        self.label = QLabel("QLabel (default font)")
        ...
        text_item = QGraphicsTextItem("QGraphicsView (default font)")
