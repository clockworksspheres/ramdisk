...
def create_parser():
    # Important: disable automatic --help on the root parser
    parser = argparse.ArgumentParser(
        prog="tool",
        description="Media / file processing CLI example",
        add_help=False,                           # ← fixes the conflict
    ...
    dl = subparsers.add_parser(
        ...
        add_help=False,                           # also good practice
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog=dedent(f"""\
    ...
    dl.add_argument("-h", "--help", action="help")          # ← safe now
