#!/usr/bin/env python3
"""
CLI with subcommands – main --help shows ALL subcommands + their main options in epilog
"""
import argparse
import sys
...
# ────────────────────────────────────────────────
#  Epilog content for subcommands (used both in main and per-command help)
# ────────────────────────────────────────────────
...
# ────────────────────────────────────────────────
#  Main epilog — shows summary of ALL subcommands + their main parameters
# ────────────────────────────────────────────────
MAIN_EPILOG = dedent("""\
    ...
    Use <command> --help for full list of options, examples and additional flags.
