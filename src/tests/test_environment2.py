#!/usr/bin/env python3
"""
Full unittest suite for ramdisk/lib/environment.py
...
sys.modules.setdefault("ramdisk", MagicMock())
sys.modules["ramdisk.config"] = config_mock

# Stub ramdisk.lib.localize
localize_mock = MagicMock()
localize_mock.VERSION = "1.2.3"
sys.modules["ramdisk.lib.localize"] = localize_mock
sys.modules["randisk.lib.localize"] = localize_mock   # typo present in source

# Stub ramdisk.lib.run_commands
run_commands_mock = MagicMock()
fake_rw_class = MagicMock()
run_commands_mock.RunWith = fake_rw_class
sys.modules["ramdisk.lib.run_commands"] = run_commands_mock
...
with patch("os.geteuid", return_value=1000), \
    ...
    sys.path.append("./..")
    import importlib
    import ramdisk.lib.environment as env_module
