...
class RunJenkinsPipeline():
    ...
    def parse_parameters(self, param_list):
        params = {}
        if param_list:
    ...
    def follow_build_output(self, server, job_name, build_number, timeout_sec):
    ...
    def controller(self, args):
        ...
        args.url = self.normalize_url(args.url)  # fix common mistake automatically

        params = self.parse_parameters(args.param)
...
if __name__ == "__main__":
    run_pipeline = RunJenkinsPipeline()
