...
class TestFsHelperLinux(unittest.TestCase):
    ...
    def setUp(self):
        # Patch CyLogger
        logger_patcher = patch("lib.fsHelper.linuxFsHelper.CyLogger")
        ...
        # Patch Environment
        env_patcher = patch("lib.fsHelper.linuxFsHelper.Environment")
        self.addCleanup(env_patcher.stop)
        env_patcher.start()

        # Patch RunWith
        run_patcher = patch("lib.fsHelper.linuxFsHelper.RunWith")
