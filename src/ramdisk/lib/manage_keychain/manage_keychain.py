...
class ManageKeychain(object):
    ...
    @note: Defined interface methods work somewhat like generic decorators
           that have a preprocess and postprocess step.
    ...
    def __init__(self, logger):
        ...
        if sys.platform.lower() == "darwin":
            ...
            raise UnsupportedOSError("This operating system is " +
                                     "not supported...")
    ...
    def listKeychains(self, *args, **kwargs):
        """
    ...
    def createKeychain(self, *args, **kwargs):
        ...
        # Preprocess logging
        self.logger.log(lp.DEBUG, "processing:" + "")
        self.logger.log(lp.DEBUG, "called by: " + inspect.stack()[1][1] +
    ...
    def showKeychainInfo(self, *args, **kwargs):
        '''
