...
usersHomeDir = mu.getUserHomeDir(user)
usersUid = mu.getUserUid(user)
usersPriGid = mu.getUserPriGid(user) 
usersComment = mu.getUserComment(user)
usersShell = mu.getUserShell(user)

print(str(usersComment))
print(str(usersUid))
print(str(usersPriGid))
print(str(usersShell))
print(str(usersHomeDir))
