# Support libraries for this project
...
* envoronment.py ( collecting both hardware and operating system and minimal software components of the system )

## Filtering what OS's are supported

* CheckApplicable.py ( this could be relevent to the whole projects, or specific pieces/libraries that support the project - currently needs work)
